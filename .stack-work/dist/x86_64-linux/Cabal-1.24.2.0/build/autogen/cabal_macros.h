...
/* package basicExam-0.1.0.0 */
#define VERSION_basicExam "0.1.0.0"
#define MIN_VERSION_basicExam(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "basicExam-0.1.0.0-F7QLerUTMEAEha14Fd5QuE"

#define CURRENT_PACKAGE_KEY "basicExam-0.1.0.0-F7QLerUTMEAEha14Fd5QuE"
